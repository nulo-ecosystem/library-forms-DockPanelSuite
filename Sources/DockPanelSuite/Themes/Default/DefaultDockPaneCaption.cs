        ...
        private InertButtonBase ButtonClose {
            get {
                if (m_buttonClose == null) {
                    m_buttonClose = new DefaultDockPaneCaptionInertButton(this,
        ...
        private InertButtonBase ButtonAutoHide {
            get {
                if (m_buttonAutoHide == null) {
                    m_buttonAutoHide = new DefaultDockPaneCaptionInertButton(this,
        ...
        private InertButtonBase ButtonOptions {
            get {
                if (m_buttonOptions == null) {
                    m_buttonOptions = new DefaultDockPaneCaptionInertButton(this,
        ...
        private static string ToolTipClose {
            get {
                if (_toolTipClose == null)
                    _toolTipClose = DefaultStrings.DockPaneCaption_ToolTipClose;
        ...
        private static string ToolTipOptions {
            get {
                if (_toolTipOptions == null)
                    _toolTipOptions = DefaultStrings.DockPaneCaption_ToolTipOptions;
        ...
        private static string ToolTipAutoHide {
            get {
                if (_toolTipAutoHide == null)
                    _toolTipAutoHide = DefaultStrings.DockPaneCaption_ToolTipAutoHide;
