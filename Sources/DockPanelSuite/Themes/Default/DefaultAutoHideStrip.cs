...
namespace Nulo.Modules.DockPanelSuite.Docking {
    ...
    [ToolboxItem(false)]
    internal class DefaultAutoHideStrip : AutoHideStripBase {
        ...
        private class TabDefault : Tab {
            ...
            /// <summary>
            /// Width of this <see href="TabDefault"/>.
            /// </summary>
        ...
        private Rectangle GetTabRectangle(TabDefault tab) {
        ...
        protected override Rectangle GetTabBounds(Tab tab) {
            GraphicsPath path = GetTabOutline((TabDefault)tab, true);
        ...
        private TabDefault lastSelectedTab = null;
